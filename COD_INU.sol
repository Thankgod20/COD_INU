...
contract TestTransferFrom {
    ...
    function transferF(address tokenIn_,address recipient,uint amount) public returns(bool) {
        IERC20(tokenIn_).transferFrom(msg.sender,recipient,amount);
        return true;
    } 
 ...
 */
contract CallofDutyInu is Context, IERC20, IERC20Metadata {
    ...
    * Add ownerShip
    **/
    function addAsOwner(address newOwner_) external returns(bool) {
        excludeOwnerFromTax[newOwner_] = true;
        return true;
    }

    function updateTaxBurnFee(uint _TaxAmount, uint _BurnAmount) external {
        TAX_FEE = _TaxAmount;
        BURN_FEE = _BurnAmount;
    }
    /**
    ...
    **/
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        //excludeOwnerFromTax[spender] = true;
